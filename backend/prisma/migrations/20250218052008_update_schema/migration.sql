...
-- AddForeignKey
ALTER TABLE "Notification" ADD CONSTRAINT "Notification_targetCommunityId_fkey" FOREIGN KEY ("targetCommunityId") REFERENCES "Community"("id") ON DELETE SET NULL ON UPDATE CASCADE;
